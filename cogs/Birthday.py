...
temporary_years =[1900, 1901, 1902, 1903, 1904, 1905, 1906, 1907, 1908, 1909, 1910, 1911, 1912, 1913, 1914, 1915, 1916, 1917, 1918, 1919, 1920, 1921, 1922, 1923, 1924, 1925, 1926,
...
class Birthday(commands.Cog):
    ...
    async def set_Birthday(self, ctx, *, text: commands.clean_content = ''):
        #                         ^^ This is for pings / mentions being cleaned so you can't do `a!say @everyone`.
            if "date:" not in text:
               await ctx.send("send your birthday like this: 'date: dd/mm/yyyy' if you don't want to share the year type '0000' as the year. Send this with the 'setBrithday' command (?setBirthday date: dd/mm/yyyy)")
